...
**The survey form project** helps collecting user informations.
...
```
cd your folder_name
git clone yourlink repo https://github.com/WilfriedM01/servey-form-projet.git
